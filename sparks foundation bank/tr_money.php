...
<head>
    ...
    <header>
        ...
        <br><br><br>
        <br>
        <h2 style="margin: 10; text-align: center;"> User Details </h2> 
    ...
    <?php
        ...
        ?>
                ...
                <td><form action="tr_money_2.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-light" style="width: 100%; background-color: #A0522D; color: white;">Transact</button></form></td>
                </tr>
        <?php $i++; } ?>
            </tbody>
            </table>
