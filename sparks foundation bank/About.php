...
<head>
    ...
    <header>
        ...
        <div class="card1 level-3">
            ...
            this is my task (Banking System) which I have been assigned to complete in a stipulated time frame. I have used HTML, CSS, Bootstrap and JavaScript 
            ...
            <div class="container">
              <section>
                ...
                <!-- Github -->
                <a class="btn btn-outline-dark btn-floating m-1" href="https://github.com/SangramjitHazarika/BankWebsite.git" role="button"><i class="fab fa-github"></i></a>
